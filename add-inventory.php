<?php
    ...
    if(isset($_POST["send"])){
        $item=$_POST["item"];//item	store_qty	date	item_status
        ...
        if($count < 1){
            $sql1="INSERT INTO item (item, store_qty, `date`, item_status) 
            VALUES('$item', '$store_qty', '$date','1')";
            ...
            $result=$fetch['store_qty'];
            $qty=$result+$store_qty;
            $sql3="UPDATE item SET store_qty='$qty' WHERE item='$item'";
            ...
            //echo "<script> alert('{$faculty_name} already exist in the database')</script>";
        }
    }
    if(isset($_GET["delete"])){
        ...
        if($query){
            echo "<script> 
                ...
                document.location.href='add-inventory.php';
                </script>";
        }else{
        ...
        <div class="row">
            <div class="col-5 border mb-3 shadow" style="margin:0 auto">
                ...
                <form action="" method="post" style="" class="pt-4 pb-4">
                    <div class="form-group row"><!--item	store_qty	date	item_status--->
                        <label for="" class="col-3 col-form-label">
                            Item name
                        </label>
                        <div class="col-9">
                            <input type="text" name="item" required class="form-control-sm" placeholder="Enter item name">  
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-9">
                            <input type="number" name="store_qty" required class="form-control-sm" placeholder="Enter quantity">  
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="" class="col-3 col-form-label">
                        ...
                        <div class="col-9">
                            <input type="date" name="date" required class="form-control-sm" placeholder="Enter date">  
                        </div>
                    </div>
                    <div class="form-group row">
        ...
        <div class="row">
            <div class="col-12">
                <table class="table table-border table-striped">
                    <thead>
                        <tr>
                            <th>#</th>  <th>Item name</th> <th>Quantity</th> <th>Purchase date</th> <th colspan="1">Action</th> 
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                        ...
                        ?>
                        <tr>
                            <td><?php echo $i; ?></td> <td><?php echo $result2["item"] ;?></td>
                            <td><?php echo $result2["store_qty"] ;?></td>
                            <td><?php echo $result2["date"] ;?></td> 
                            <td>
                                <a href="add-inventory.php?delete=<?php echo $result2["item_id"]?>"
